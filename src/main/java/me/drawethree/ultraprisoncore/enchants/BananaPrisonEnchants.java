...
import me.drawethree.ultraprisoncore.enchants.api.BananaPrisonEnchantsAPI;
import me.drawethree.ultraprisoncore.enchants.api.BananaPrisonEnchantsAPIImpl;
...
public final class BananaPrisonEnchants implements BananaPrisonModule {

    @Getter
    private static BananaPrisonEnchants instance;
    private final HashMap<UUID, ItemStack> currentPickaxes = new HashMap<>();

    @Getter
    private BananaPrisonEnchantsAPI api;
    ...
    public BananaPrisonEnchants(BananaPrisonCore UltraPrisonCore) {
        instance = this;
    ...
    public void reload() {
        ...
        BananaPrisonEnchantment.reloadAll();
    }
    ...
    public void enable() {
        ...
        this.api = new BananaPrisonEnchantsAPIImpl(enchantsManager);
        this.loadMessages();
