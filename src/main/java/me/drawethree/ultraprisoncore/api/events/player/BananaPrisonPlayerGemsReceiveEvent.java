...
public class BananaPrisonPlayerGemsReceiveEvent extends BananaPrisonPlayerEvent implements Cancellable {
	 ...
	 */
	public BananaPrisonPlayerGemsReceiveEvent(ReceiveCause cause, OfflinePlayer player, long amount) {
		super(player);
		this.cause = cause;
		this.amount = amount;
	}
