...
public class BananaPrisonPlayerEnchantEvent extends BananaPrisonPlayerEvent implements Cancellable {
	 ...
	 */
	public BananaPrisonPlayerEnchantEvent(Player player, long tokenCost, int level) {
		super(player);
