...
import me.drawethree.ultraprisoncore.ranks.api.BananaPrisonRankupAPI;
import me.drawethree.ultraprisoncore.ranks.api.BananaPrisonRankupAPIImpl;
...
@Getter
public final class BananaPrisonRankup implements BananaPrisonModule {
    ...
    @Getter
    private BananaPrisonRankupAPI api;
    ...
    public BananaPrisonRankup(BananaPrisonCore UltraPrisonCore) {
    ...
    public void enable() {
        ...
        api = new BananaPrisonRankupAPIImpl(this);
