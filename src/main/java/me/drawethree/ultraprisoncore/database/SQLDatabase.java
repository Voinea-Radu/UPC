...
public abstract class SQLDatabase extends Database {
    ...
    protected BananaPrisonCore plugin;
    ...
    public SQLDatabase(BananaPrisonCore plugin) {
        super(plugin);
        this.plugin = plugin;
    }
    ...
    public void createTables() {
        Schedulers.async().run(() -> {
            ...
            execute("CREATE TABLE IF NOT EXISTS " + GANGS_TABLE_NAME + "(name varchar(36) NOT NULL UNIQUE, owner varchar(36) NOT NULL, members text, primary key (name))");
        });
    }
