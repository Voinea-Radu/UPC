...
import me.drawethree.ultraprisoncore.pickaxelevels.api.BananaPrisonPickaxeLevelsAPI;
import me.drawethree.ultraprisoncore.pickaxelevels.api.BananaPrisonPickaxeLevelsAPIImpl;
...
public final class BananaPrisonPickaxeLevels implements BananaPrisonModule {
    ...
    @Getter
    private BananaPrisonPickaxeLevelsAPI api;
    @Getter
    private BananaPrisonCore core;
    private boolean enabled;

    public BananaPrisonPickaxeLevels(BananaPrisonCore UltraPrisonCore) {
    ...
    public void enable() {
        ...
        this.api = new BananaPrisonPickaxeLevelsAPIImpl(this);
    }
